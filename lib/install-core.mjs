...
export async function install(ctx = {}) {
  ...
  if (!existsSync(mcpSrc)) {
    ...
    // fail to load. package.json is not optional either: lib/mcp.mjs derives
    // serverInfo.version from it so the version can never drift from the tree
    // that was actually installed.
    for (const name of ['mcp.mjs', 'engine.mjs']) {
