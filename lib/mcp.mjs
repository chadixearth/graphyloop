...
const TOOLS = [
  ...
  },
  {
    name: 'skills_status',
    description:
      'Which skills are actually installed on this machine (project .opencode/skills, ~/.config/opencode/skills, ~/.claude/skills). Reports the graphyloop-bundled skills (graphyloop-waves, supabase-setup, vercel-deploy, secrets-hygiene, swarm-memory) and which skills the squad routes on but are missing. Call it before claiming a skill was used — a missing skill is stated in one line, never faked.',
    inputSchema: { type: 'object', properties: {}, required: [] },
  },
  {
    name: 'shutdown',
