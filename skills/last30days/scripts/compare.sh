...
opencode -p --dangerously-skip-permissions "/last30days $TOPIC" > /dev/null 2>&1 || true
...
echo "  This takes 2-4 minutes..."
opencode -p --dangerously-skip-permissions "/last30days-beta $TOPIC" > /dev/null 2>&1 || true
...
echo ""
echo "To compare, run in OpenCode:"
