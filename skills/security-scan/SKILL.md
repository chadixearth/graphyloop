...
name: security-scan
description: Scan your OpenCode configuration (.opencode/ directory) for security vulnerabilities, misconfigurations, and injection risks using AgentShield. Checks AGENTS.md, settings.json, MCP servers, hooks, and agent definitions.
origin: ECC
---
...
```bash
# Requires ANTHROPIC_API_KEY (or your provider's equivalent)
export ANTHROPIC_API_KEY=your-key
npx ecc-agentshield scan --stream
```
